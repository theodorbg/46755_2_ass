...
os.makedirs('part1/results/scenarios', exist_ok=True)

# Save in-sample scenarios
with open('part1/results/scenarios/in_sample_scenarios.pkl', 'wb') as f:
    pickle.dump(in_sample_scenarios, f)

# Save out-of-sample scenarios
with open('part1/results/scenarios/out_of_sample_scenarios.pkl', 'wb') as f:
